        ...
        <div className="flex-1 space-y-6 overflow-y-auto px-5 py-6">
          {task.description && (
            <div>
              ...
              <p className="mt-2 text-sm text-slate-700 whitespace-pre-wrap">{task.description}</p>
            </div>
          )}
          <div className="grid gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-4 text-xs text-slate-500 sm:grid-cols-2">
            {task.due_date && (
              <p>
